...
modèle statistique utilisé quand la variable réponse est catégorielle avec plus de deux catégories, sans ordre naturel entre elles. Phénologie est un état discret, non ordonné, avec plusieurs modalités.
...
acp1 <- dudi.pca(recouvrement_num, scale=T,  scannf=F, nf=4)
scatter(acp1)
