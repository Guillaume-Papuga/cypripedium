...
glmm_final_pheno <- glmer(
  detection ~ site + session + site:session + phenologie_verif + nb_individus_sc + risque_erreur + nb_detect_sc + hauteur_moy_sc + (1|observateur) + (1|site:quadrat:marquage) + (1|site:quadrat),
  data = tab_complet,
  family = binomial,
...
##Pour le nombre de détection par observateur
...
##Pour la densité de couvert végétal
